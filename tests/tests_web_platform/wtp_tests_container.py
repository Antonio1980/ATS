...
from tests.tests_web_platform.login_tests.C3671_login_page_ui_test import LogInPageUiTest
from tests.tests_web_platform.login_tests.C3690_login_test import LogInTest
from tests.tests_web_platform.login_tests.C3832_login_ddt_test import LogInTestDDT
from tests.tests_web_platform.login_tests.C3962_links_on_login_page_test import LinksOnLogInPageTest
from tests.tests_web_platform.login_tests.C3963_email_verification_ui_test import EmailVerificationScreenTest
