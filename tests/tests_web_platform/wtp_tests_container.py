...
from tests.tests_end2end.wtp_tests.C3750_sign_up_browser_stack_test import SignUpBrowserStackTest
from tests.tests_web_platform.end2end_tests.C3750_sign_up_with_given_email_test import SignUpWithGivenEmailTest
from tests.tests_end2end.wtp_tests.C3750_sign_up_with_random_email_test import SignUpWithRandomEmailTest
...
from tests.tests_web_platform.signin_tests.C3983_signin_positive_test import SignInTestPositive
...
from tests.tests_web_platform.signin_tests.C3984_signin_without_captcha_test import SignInWithoutCaptchaTest
...
signup_remote = unittest.TestLoader().loadTestsFromTestCase(SignUpBrowserStackTest)
...
signin = unittest.TestLoader().loadTestsFromTestCase(SignInTestPositive)
...
signin_without_captcha = unittest.TestLoader().loadTestsFromTestCase(SignInWithoutCaptchaTest)
...
# loading test suites
e2e_suite = unittest.TestSuite([forgot_password, signup_remote, signup_standalone, signup_random, ])
