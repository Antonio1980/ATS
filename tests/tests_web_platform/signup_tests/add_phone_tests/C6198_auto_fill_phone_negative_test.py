...
class AutoFillPhoneNegativeTest(unittest.TestCase):
    def setUp(self):
        self.test_case = '6198'
    ...
    def test_negative_auto_fill_phone(self, browser):
        ...
        delay = 5
        step1, step2, step3, step4, step5 = False, False, False, False, True
        try:
            ...
            try:
                ...
                print("{0} test_negative_auto_fill_phone failed with error {0}".format(e.__class__.__name__, e.__cause__))
        finally:
