    ...
    def test_ui_verified_email(self, browser):
        ...
        try:
            ...
            try:
                ...
                continue_button = Browser.find_element(self.driver, self.locators.CONTINUE_BUTTON)
                Browser.try_click(self.driver, continue_button, delay - 4)
                if Browser.wait_url_contains(self.driver, user_open_account_url, delay):
                    step3 = True
