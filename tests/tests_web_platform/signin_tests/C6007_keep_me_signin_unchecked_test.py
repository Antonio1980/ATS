...
class SignInUncheckedTest(unittest.TestCase):
    def setUp(self):
        self.test_case = '6007'
    ...
    @unpack
    def test_unchecked_sign_in(self, browser):
        ...
        try:
            ...
            driver = WebDriverFactory.get_browser(browser)
            self.home_page.open_home_page(driver, delay)
