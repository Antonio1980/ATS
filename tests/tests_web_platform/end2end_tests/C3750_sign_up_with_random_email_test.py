...
class SignUpWithRandomEmailTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.test_case = '3750'
        ...
        response = Instruments.get_guerrilla_mail("GET", "get_email_address")
    ...
    def test_sign_up_with_random_email(self):
        delay, customer_id = 5, ""
        ...
        try:
            ...
            response1 = Instruments.get_guerrilla_mail("GET", "get_email_list&offset=0&site=guerrillamail.com&_=" +
                                                       self.username, self.sid_token)
            email_id = str(response1['list'][0]['mail_id'])
            response2 = Instruments.get_guerrilla_mail("GET", "fetch_email&email_id=mr_" + email_id +
                                                       "&site=guerrillamail.com&_=", self.sid_token)
