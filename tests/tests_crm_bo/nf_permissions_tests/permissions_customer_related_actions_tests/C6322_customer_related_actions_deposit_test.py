...
class CustomerRelatedActionsDeposit(unittest.TestCase):
    def setUp(self):
        self.test_case = '6322'
    ...
    def test_customer_permission_test(self, browser):
        ...
        delay = 5
        step1, step2, step3, step4, step5, step6, step7, step8, step9, step10 = False, False, False, False, False, False, False
        try:
