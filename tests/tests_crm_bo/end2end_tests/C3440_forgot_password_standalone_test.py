...
class ForgotPasswordStandaloneTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.users_file = BaseConfig.CRM_TESTS_USERS
    ...
    def test_login_with_new_password(self):
        ...
        try:
            ...
            step7 = self.login_page.set_new_password(self.driver, new_password, new_password + "Qa!Qa1")
            step8 = self.home_page.logout(self.driver, delay)
            step9 = self.login_page.login(self.driver, self.new_username, new_password + "Qa!Qa1")
        finally:
