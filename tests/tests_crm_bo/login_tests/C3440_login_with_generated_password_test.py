...
class LogInWithNewPasswordTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.test_case = '3440'
    ...
    def test_login_with_new_password(self):
        ...
        try:
            ...
            result4 = self.login_page.set_new_password(self.driver, new_password, new_password + "Qa")
            result5 = self.home_page.logout(self.driver, delay)
            result6 = self.login_page.login(self.driver, self.username, new_password + "Qa")
        finally:
