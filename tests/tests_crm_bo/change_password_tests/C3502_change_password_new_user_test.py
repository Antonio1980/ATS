...
class ChangePasswordNewUserTest(unittest.TestCase):
    ...
    def test_login_with_new_password(self, browser):
        ...
        try:
            ...
            step4 = self.login_page.go_to_login_page(self.driver, user_index_page_url)
            step5 = self.login_page.login(self.driver, self.forgotten_username, new_password)
            step6 = self.login_page.set_new_password(self.driver, new_password, new_password + "Qa")
