...
CUSTOMER_DROPDOWN = "//span[@class='filter-option pull-left'][contains(.,'')]"
CUSTOMER_ID_OPTION = "//*[@class='text'][contains(text(),'Customer ID')]"
CUSTOMER_EMAIL_OPTION = "//*[@class='text'][contains(text(),'Customer Email')]"
CUSTOMER_NAME_OPTION = "//*[@class='text'][contains(text(),'Customer Name')]"
