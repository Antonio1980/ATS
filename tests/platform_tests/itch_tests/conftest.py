...
@automation_logger(logger)
def add_balance_itch(request, r_customer):
    if request.param:
...
@pytest.fixture(scope="class")
@pytest.mark.parametrize('add_balance_itch', [[quoted_currency]], indirect=True)
@automation_logger(logger)
def itch_order_buy(request, r_customer, add_balance_itch):
...
@pytest.fixture(scope="class")
@pytest.mark.parametrize('add_balance_itch', [[base_currency]], indirect=True)
@automation_logger(logger)
def itch_order_sell(request, r_customer, add_balance_itch):
