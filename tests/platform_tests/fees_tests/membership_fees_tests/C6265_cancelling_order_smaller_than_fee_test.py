...
class TestCancelOrderSmallerThanFee(object):

    @allure.step("test_cancel_order_smaller_than_fee")
    ...
    def test_cancel_order_smaller_than_fee(self, r_customer_sql, preconditions, safe_price):
        ...
        assert results[0] == 1 and results[1] == 1 and results[2] == 2, f"Order status isn't changed - {results[2]}"
