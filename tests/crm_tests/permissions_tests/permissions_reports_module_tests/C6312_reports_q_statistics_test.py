...
@ddt
class TestReportsQStatistics(unittest.TestCase):
    def setUp(self):
        self.test_case = '6312'
        ...
        self.local_permissions_entity_name = "'Reports - Q Statistics'"
        self.local_sub_module_name = "'Reports - Q Statistics'"
    ...
    def test_reports_permission_test(self, browser):
        ...
        try:
            ...
            q_statistics_dropdown_title = Browser.wait_element_presented(self.driver,
                                                                         self.locators.Q_STATISTICS_DROPDOWN_TITLE,
                                                                         delay)
            Browser.click_on_element(q_statistics_dropdown_title)
            assert Browser.wait_element_presented(self.driver, self.locators.Q_STATISTICS_TITLE_ON_Q_STATISTICS_PAGE,
                                                  delay)
            step5 = True
