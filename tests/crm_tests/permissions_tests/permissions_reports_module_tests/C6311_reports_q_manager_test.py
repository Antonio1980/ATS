...
@ddt
class TestReportsQManager(unittest.TestCase):
    def setUp(self):
        self.test_case = '6312'
        ...
        self.local_permissions_entity_name = "'Reports - Q Manager'"
        self.local_sub_module_name = "'Reports - Q Manager'"
    ...
    def test_reports_permission_test(self, browser):
        ...
        try:
            ...
            q_manager_dropdown_title = Browser.wait_element_presented(self.driver,
                                                                         self.locators.Q_MANAGER_DROPDOWN_TITLE, delay)
            Browser.click_on_element(q_manager_dropdown_title)
            assert Browser.wait_element_presented(self.driver, self.locators.Q_MANAGER_TITLE_ON_Q_MANAGER_PAGE, delay)
            step5 = True
