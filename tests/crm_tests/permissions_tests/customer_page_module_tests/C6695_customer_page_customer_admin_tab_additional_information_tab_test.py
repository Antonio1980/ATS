...
@ddt
class TestCustomerPageCustomerAdminTabAdditionalInformationTab(unittest.TestCase):
    def setUp(self):
        self.test_case = '6695'
        ...
        self.local_permissions_entity_name = "'Customer Page - Customer Admin Tab - Additional Information Tab'"
        self.local_sub_module_name = "'Customer Page - Customer Admin Tab - Additional Information Tab'"
        ...
        self.local_permissions_entity_name_tab = "'Customer Page - Customer Admin Tab'"
    ...
    def test_customer_permission_test(self, browser):
        ...
        try:
            ...
            additional_information_tab = Browser.wait_element_presented(self.driver, self.locators.ADDITIONAL_INFORMATION_TAB,
                                                  delay)
            Browser.click_on_element(additional_information_tab)
            assert Browser.wait_element_presented(self.driver, self.locators.ADDITIONAL_INFORMATION_CONTENT, delay)
