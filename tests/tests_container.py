...
wtp_forgot_password_ddt = unittest.TestLoader().loadTestsFromTestCase(ForgotPasswordTestDDT)
...
# login suite
wtp_login_ui = unittest.TestLoader().loadTestsFromTestCase(LogInPageUiTest)
wtp_login = unittest.TestLoader().loadTestsFromTestCase(LogInTest)
wtp_login_ddt = unittest.TestLoader().loadTestsFromTestCase(LogInTestDDT)
wtp_login_links = unittest.TestLoader().loadTestsFromTestCase(LinksOnLogInPageTest)
...
wtp_signup_ddt = unittest.TestLoader().loadTestsFromTestCase(RegistrationTestDDT)
