...
class CustomerPage(BasePage):
    def __init__(self):
        ...
        self_url = "customers/page/"
        self.customer_page_url = self.crm_base_url + self_url
        self.customer_admin_url = self.customer_page_url + "{0}#customer_admin_status".format(customer_id)
        self.customer_deposit_url = self.customer_page_url + "{0}#customer_dw".format(customer_id)
        self.customer_balance_url = self.customer_page_url + "{0}#customer_balance".format(customer_id)
