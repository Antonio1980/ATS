...
class Browser(object):
    ...
    def close_tab(cls, driver):
        ...
        try:
            ...
            print("{0} method close_tab failed with error {0}".format(e.__class__.__name__, e.__cause__))
    ...
    def refresh_page(cls, driver):
        ...
        try:
            ...
            print("{0} method refresh_page failed with error {0}".format(e.__class__.__name__, e.__cause__))
    ...
    @classmethod
    def check_not_send_key(cls, element, value):
        try:
    ...
    @classmethod
    def choose_option_from_dropdown(cls, driver, dropdown_locator, dropdown_field_locator, dropdown_option, delay):
        """
