...
class Browser:
    ...
    def close_tab(cls, driver):
        ...
        try:
            ...
            logger.logger.error("{0} method close_tab failed with error {0}".format(e.__class__.__name__, e.__cause__),
                                e)
    ...
    @classmethod
    @automation_logger(logger)
    def click_with_wait_and_offset(cls, driver, element, x=5, y=5):
        """
    ...
    def switch_window(cls, driver, element):
        ...
        :param driver: web_driver instance.
        :param element: web element.
        :return: driver state on switched window.
        """
    ...
    def refresh_page(cls, driver):
        ...
        try:
            ...
            logger.logger.exception(F"{e.__class__.__name__} method refresh_page failed with error {e}")
    ...
    @classmethod
    @automation_logger(logger)
    def possibility_to_send_keys(cls, element, query):
        try:
            element.clear()
            element.send_keys(query)
        except InvalidElementStateException:
            logger.logger.info("possibility_to_send_keys: Web element not acceptable for keys as expected.")
            return True
        return False
    ...
    def search_element(cls, driver, locator, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} search_element raising error: {e}")
            return False
    ...
    @classmethod
    @automation_logger(logger)
    def wait_for_new_window(cls, driver, delay):
        """
        Waits and checks if another window is open.
        :param driver: web_driver instance.
        :param delay: seconds to wait.
        :return: True if additional_tests window is open and False otherwise.
        """
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} wait_for_new_window raising error: {e}")
            return False
    ...
    def click_on_element_by_locator(cls, driver, locator, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} click_on_element_by_locator raising error: {e}")
            raise e
    ...
    @classmethod
    @automation_logger(logger)
    def choose_option_from_dropdown(cls, driver, dropdown_locator, dropdown_field_locator, dropdown_option):
        """
        ...
        action.wait(2)
        dropdown_field = cls.search_element(driver, dropdown_field_locator, 3.0)
        action.click(dropdown_field)
        action.wait(2)
        action.send_keys(str(dropdown_option))
        action.wait(2)
    ...
    @classmethod
    @automation_logger(logger)
    def check_element_not_visible(cls, driver, locator, delay):
        """
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} check_element_not_visible raising error: {e}")
            return False
    ...
    def check_element_is_not_presented(cls, driver, locator):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} check_element_is_not_presented raising error: {e}")
            return True
        return False
    ...
    def check_element_not_presented(cls, driver, locator, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} check_element_not_presented raising error: {e}")
            return False
    ...
    def check_element_to_not_be_selected(cls, driver, locator, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} check_element_to_not_be_selected raising error: {e}")
            return False

    @classmethod
    @automation_logger(logger)
    def wait_number_of_windows(cls, driver, number, delay):
        """
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} wait_number_of_windows raising error: {e}")
            return False
    ...
    def wait_url_contains(cls, driver, url, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} wait_url_contains raising error: {e}")
            return False
    ...
    def wait_url_matches(cls, driver, url, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} wait_url_matches raising error: {e}")
            return False
    ...
    def wait_element_visible(cls, driver, locator, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} wait_element_visible raising error: {e}")
            return False
    ...
    def wait_element_presented(cls, driver, locator, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} wait_element_presented raising error: {e}")
            return False
    ...
    def wait_element_to_be_selected(cls, driver, locator, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} wait_element_to_be_selected raising error: {e}")
            return False
    ...
    def wait_element_clickable(cls, driver, locator, delay):
        ...
        try:
            ...
            logger.logger.error(F"{e.__class__.__name__} wait_element_clickable raising error: {e}")
            return False
