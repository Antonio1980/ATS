...
class reify(object):
    """Put the result of a method which uses this (non-tests_data)
...
class WheelFile(object):
    ...
    def datadir_name(self):
        return "%s.tests_data" % self.parsed_filename.group('namever')
    ...
    def parsed_wheel_info(self):
        """Parse wheel metadata (the .tests_data/WHEEL file)"""
    ...
    def install_paths(self):
        ...
        ('purelib', 'platlib', 'headers', 'scripts', 'tests_data').
