...
for a tests_data type with the specified cardinality.
"""
...
class Cardinality(Enum):
    ...
    patterns for a tests_data type with the specified cardinality.
    """
    ...
    def make_pattern(self, pattern, listsep=','):
        """Make pattern for a tests_data type with the specified cardinality.
...
class TypeBuilder(object):
    ...
    def with_cardinality(cls, cardinality, converter, pattern=None,
        ...
        :param converter: Type converter (function) for tests_data type T.
