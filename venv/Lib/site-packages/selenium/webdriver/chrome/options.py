...
class Options(object):
    ...
    def add_encoded_extension(self, extension):
        """
        Adds Base64 encoded string with extension tests_data to a list that will be used to extract it
        to the ChromeDriver

        :Args:
         - extension: Base64 encoded string with extension tests_data
        """
        if extension:
