# -*- coding: UTF-8 -*-
"""
Functionality to support user-specific configuration tests_data (userdata).
"""
...
# -----------------------------------------------------------------------------
class UserData(dict):
    """Dictionary-like user-tests_data with some additional features:
    ...
    def getas(self, convert, name, default=None, valuetype=None):
        """Converts the value of user-tests_data parameter from a string into a
        specific value type.
    ...
    def getbool(self, name, default=False):
        """Converts user-tests_data string-value into boolean value (if possible).
        Supported truth string values:
...
class UserDataNamespace(object):
    """Provides a light-weight dictview to the user tests_data that allows you
