...
class Scenario(TagAndStatusStatement, Replayable):
    ...
    def reset(self):
        """Reset the internal tests_data to reintroduce new-born state just after the
        ctor was called.
        """
...
class ScenarioOutlineBuilder(object):
    ...
    def make_scenario_name(self, outline_name, example, row, params=None):
        ...
        Placeholders for row tests_data are replaced by values.
...
class ScenarioOutline(Scenario):
    ...
    tests_data from the *feature file*.
    ...
    def reset(self):
        """Reset runtime temporary tests_data like before a test run."""
...
class Step(BasicStatement, Replayable):
    ...
    def reset(self):
        """Reset temporary runtime tests_data to reach clean state again."""
    ...
    def set_values(self, table_row):
        ...
        :param table_row:  Placeholder tests_data for example row.
...
class Table(Replayable):
    ...
    Table instance tests_data is accessible using a number of methods:
    ...
    **indexed access**
    ...
    Tables are also comparable, for what that's worth. Headings and row tests_data
    are compared.
    ...
    def __eq__(self, other):
        if isinstance(other, Table):
            ...
            # -- ASSUME: table <=> raw tests_data comparison
            other_rows = other
    ...
    def assert_equals(self, data):
        """Assert that this table's cells are the same as the supplied "tests_data".

        The tests_data passed in must be a list of lists giving:
...
class Row(object):
    ...
    Row tests_data is accessible using a number of methods:
    ...
    **indexed access**
    ...
    def as_dict(self):
        """Converts the row and its cell tests_data into a dictionary.
        :return: Row tests_data as dictionary (without comments, line info).
        """
