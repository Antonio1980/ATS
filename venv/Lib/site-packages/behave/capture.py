...
class Captured(object):
    """Stores and aggregates captured output tests_data."""
    empty = u""
    linesep = u"\n"
    ...
    @property
    def output(self):
        """Makes a simple report of the captured tests_data by concatenating
        all parts.
        """
    ...
    def add(self, captured):
        """Adds/appends captured output tests_data to this object.

        :param captured:    Captured object whose tests_data should be added.
    ...
    def make_report(self):
        """Makes a detailled report of the captured output tests_data.
...
class CaptureController(object):
    ...
    @property
    def captured(self):
        """Provides access of the captured output tests_data.
