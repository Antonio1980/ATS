...
def use_fixture_by_tag(tag, context, fixture_registry):
    ...
    If the fixture-tag is known, the fixture tests_data is retrieved from the
    fixture registry.
    ...
    :param fixture_registry:  Registry maps fixture-tag to fixture tests_data.
    :return: Fixture-setup result (same as: use_fixture())
    :raises LookupError: If fixture-tag/fixture is unknown.
    :raises ValueError: If fixture tests_data type is not supported.
    """
