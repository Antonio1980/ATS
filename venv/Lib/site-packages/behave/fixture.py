...
def iscoroutinefunction(func):
    ...
    #    Checks also if @asyncio.coroutine testrail_update is not used.
...
def is_context_manager(func):
    ...
    similar to :func`contextlib.contextmanager()` function testrail_update.
...
def fixture(func=None, name=None, pattern=None):
    """Fixture testrail_update (currently mostly syntactic sugar).
    ...
    .. seealso::
        ...
        * :func:`contextlib.contextmanager` testrail_update
        * `@pytest.fixture`_
    """
