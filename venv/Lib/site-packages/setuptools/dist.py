...
def write_pkg_file(self, file):
    """Write the PKG-INFO format tests_data to a file object.
    """
...
class Distribution(Distribution_parse_config_files, _Distribution):
    """Distribution with support for features, tests, and package tests_data
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'package_data' -- a dictionary mapping package names to lists of filenames
        or globs to use to find tests_data files contained in the named packages.
    ...
    def patch_missing_pkg_info(self, attrs):
        # Fake up a replacement for the tests_data that would normally come from
