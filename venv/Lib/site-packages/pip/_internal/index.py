    ...
    def find_requirement(self, req, upgrade):
        ...
        compatible_versions = set(
            req.specifier.filter(
                ...
                # types. This way we'll use a str as a common tests_data interchange
    ...
    def links(self):
        ...
        for anchor in self.parsed.findall(".//a"):
            if anchor.get("href"):
                ...
                pyrequire = anchor.get('tests_data-requires-python')
...
class Link(object):
    ...
    def __init__(self, url, comes_from=None, requires_python=None):
        ...
        requires_python:
            ...
            in PEP 345. This may be specified by a tests_data-requires-python
