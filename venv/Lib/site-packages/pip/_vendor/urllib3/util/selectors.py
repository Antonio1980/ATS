...
SelectorKey = namedtuple('SelectorKey', ['fileobj', 'fd', 'events', 'tests_data'])
...
class BaseSelector(object):
    ...
    def modify(self, fileobj, events, data=None):
        """ Change a registered file object monitored events and tests_data. """
        ...
        if events != key.events:
            ...
            # Use a shortcut to update the tests_data.
